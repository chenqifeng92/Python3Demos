...
def main():
    ...
    # driver.get("https://www.zhihu.com/question/35949042") # 为什么很多女人喜欢穿丝袜？
    ...
    with open("/Users/chenqifeng/Downloads/zhihuSpider/rawfile/raw_result.txt", 'w') as girls: # 存储路径里的文件夹需要事先创建。
        girls.write(result_bf)
    girls.close()
    print("Store raw data successfully!!!")

    # ****************   Find all <nonscript> nodes and store them   *****************************************
    with open("/Users/chenqifeng/Downloads/zhihuSpider/rawfile/noscript_meta.txt", 'w') as noscript_meta:
    ...
    with open("/Users/chenqifeng/Downloads/zhihuSpider/rawfile/img_meta.txt", 'w') as img_meta:
        count = 0
        for img in img_nodes:
            if img.get('src') is not None:
                ...
                img_meta.write(line)
                urllib.request.urlretrieve(img_url, "/Users/chenqifeng/Downloads/zhihuSpider/image/" + str(count) + ".jpg") # 一个一个下载图片
                count += 1
